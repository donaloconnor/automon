...
/*!
    \fn QtAbstractAnimation::currentIterationChanged(int currentIteration)

    QtAbstractAnimation emits this signal whenever the current iteration
...
void QUnifiedTimer::timerEvent(QTimerEvent *event)
{
    ...
    if (event->timerId() == startAnimationTimer.timerId()) {
...
void QUnifiedTimer::registerAnimation(QtAbstractAnimation *animation)
{
    ...
    if (!startAnimationTimer.isActive())
        startAnimationTimer.start(0, this); // we delay the actual start of the animation
}
...
void QtAbstractAnimationPrivate::setState(QtAbstractAnimation::State newState)
{
    ...
    case QtAbstractAnimation::Stopped:
        ...
        if (dura == -1 || iterationCount < 0
            || (oldDirection == QtAbstractAnimation::Forward && (oldCurrentTime * (oldCurrentIteration + 1)) == (dura * iterationCount))
...
/*!
    \property QtAbstractAnimation::iterationCount
...
*/
int QtAbstractAnimation::iterationCount() const
{
    Q_D(const QtAbstractAnimation);
    return d->iterationCount;
}
void QtAbstractAnimation::setIterationCount(int iterationCount)
{
    Q_D(QtAbstractAnimation);
...
/*!
    \property QtAbstractAnimation::currentIteration
    ...
    When the current iteration changes, QtAbstractAnimation emits the
    currentIterationChanged() signal.
*/
int QtAbstractAnimation::currentIteration() const
{
    Q_D(const QtAbstractAnimation);
