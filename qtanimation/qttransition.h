...
class Q_ANIMATION_EXPORT QtTransition : public QtAbstractTransition
{
    Q_OBJECT
public:
    QtTransition(const QList<QEvent::Type> &eventTypes = QList<QEvent::Type>());
    QtTransition(QEvent::Type eventType);
    ~QtTransition();
...
protected:
    QtTransition(QtTransitionPrivate &dd, const QList<QEvent::Type> &eventTypes);
    QtTransition(QtTransitionPrivate &dd, QEvent::Type eventType);
