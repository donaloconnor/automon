...
/*!
  ...
  the given \a object, with the given \a key and \a modifiers.
*/
QtKeyEventTransition::QtKeyEventTransition(QObject *object, QEvent::Type type,
                                         int key, Qt::KeyboardModifiers modifiers)
    : QtEventTransition(*new QtKeyEventTransitionPrivate, object,
                       new QBasicKeyEventTransition(type, key, modifiers))
{
}
...
/*!
  \reimp
*/
bool QtKeyEventTransition::testCondition(QEvent *event) const
{
