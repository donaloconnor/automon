...
class QBasicKeyEventTransitionPrivate : public QtAbstractTransitionPrivate
{
...
/*!
  Constructs a new event transition for events of the given \a type.
*/
QBasicKeyEventTransition::QBasicKeyEventTransition(QEvent::Type type, int key,
                                         Qt::KeyboardModifiers modifiers)
    : QtAbstractTransition(*new QBasicKeyEventTransitionPrivate, type)
{
...
/*!
  \reimp
*/
bool QBasicKeyEventTransition::testCondition(QEvent *event) const
{
